...
"""
Ex__3_single_digit_subtractor.py:
Answer to Ch 1 Ex 3 (single digit subtractor).
"""
...
# The difference is returned as digit1 and
# the carry output is 0 (borrow) or 1 (not borrow).
